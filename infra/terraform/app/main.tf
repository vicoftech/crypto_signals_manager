...
locals {
  ...
  lambda_env = {
    ...
    COOLDOWN_MINUTES                   = "90"
    LIVE_EXIT_PROTECTION_GRACE_MINUTES = "15"
    EXCHANGE_PROTECTION_STRICT         = "true"
    PROTECTION_MAX_RETRIES             = "6"
    PROTECTION_ALERT_COOLDOWN_MIN      = "30"
    PROTECTION_BROKEN_ALERT_MIN        = "15"
